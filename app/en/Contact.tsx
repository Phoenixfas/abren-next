        ...
        <div className="flex-[1.5] relative">
            <div className="2xl:w-[600px] xl:w-[500px] h-screen bg-white rounded-lg translate-y-20 px-[50px] py-[100px]">
                <form onSubmit={handleSubmit} className="w-full h-full flex flex-col items-center gap-[80px]" >
                    <input className="w-full outline-none border-b border-teal-300 text-xl py-1 font-medium placeholder:text-[#999]" type="text" name="name" id="name" placeholder="Name" required />
                    <input className="w-full outline-none border-b border-teal-300 text-xl py-1 font-medium placeholder:text-[#999]" type="email" name="email" id="email" placeholder="Email" required />
                    <input className="w-full outline-none border-b border-teal-300 text-xl py-1 font-medium placeholder:text-[#999]" type="tel" name="phone" id="phone" placeholder="Phone" required />
                    <input className="w-full outline-none border-b border-teal-300 text-xl py-1 font-medium placeholder:text-[#999]" type="text" name="message" id="message" placeholder="Message" required />
